          ...
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a className="flex items-center" href="/">
              <img
                ...
                alt=""
              />
              <span className="text-2xl ">Dina Lock Smith</span>
            </a>
          </div>
            ...
            <Popover className="relative">
              {({ open }) => (
                <>
                  ...
                  >
                    <Popover.Panel className="absolute z-[100] -ml-4 mt-3 w-screen max-w-md transform lg:left-1/2 lg:ml-0 lg:max-w-2xl lg:-translate-x-1/2">
